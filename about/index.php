  ...
  <div class="body">
    <div class="body__inner"> 
      ...
      <section class="chapter">
        <h3 class="chapter__heading" id="how-watsi-works">
          How Watsi Works
        </h3>
        <ol class="process">
          <li class="process__item process__item--connect">
            ...
            <span class="process__icon icon-person"></span>
          </li>
      ...
      <section class="chapter">
        <h3 class="chapter__heading" id="story">Story</h3>
...
In our experience, most non-profits aren’t efficient. We are different. We believe motivation and adaptation are more important than a fancy office and expensive business cards.
          <br /><br />
          <h4 class="chapter__subheading">Transparency</h4>
We are 100% transparent. Period. All relevant information, from transfer receipts to patient waivers, are available on our <a class="chapter__link" href="https://docs.google.com/spreadsheet/pub?key=0Ah3wJ9CRQzyHdDZSaEF1X1JsRm1yZ251d0RQZ0VmRGc&output=html" target="_blank">Transparency Google Document</a>. Watsi is an open book.
        </p>
      </section>
    
      <section class="chapter chapter--contact">
        <h3 class="chapter__heading" id="contact">Contact</h3>
        <p class="chapter__copy">
          Please email us at <a class="chapter__link" href="mailto:connect@watsi.org">connect@watsi.org</a> or call us at <a class="chapter__link" href="tel:+12567928747">(256) 792-8747</a> and we will get back to you as soon as possible.
          <br /><br />
    ...
    <div class="page__column page__column--right">
      ...
      <section class="chapter">
        <h3 class="chapter__heading" id="about">About</h3>
        <p class="chapter__copy">
          ...
          <br /><br />
          We invite you to join us and <a class="chapter__link" href="/fund-treatments">change the world</a>, one treatment, one person, and one life at a time. 
        </p>
      </section>
      
      <section class="chapter">
        <h3 class="chapter__heading" id="get-involved">Get Involved</h3>
        <p class="chapter__copy">
          The most direct way for you to get involved is to fund a treatment. Every time you <a class="chapter__link" href="/fund-treatments">fund a treatment</a> on Watsi, you help grow our community, expand our reach, and spread our message.
          <br /><br />
          <h4 class="chapter__subheading">Connect with us</h4>
          Like us on <a class="chapter__link" href="https://www.facebook.com/Watsi.org" target="_blank">Facebook</a>, follow us on <a class="chapter__link" href="https://twitter.com/watsi" target="_blank">Twitter</a>, and check out our <a class="chapter__link" href="http://watsi.tumblr.com/" target="_blank">blog</a> to get the latest news, updates, and information!
          <br /><br />
          <h4 class="chapter__subheading">Donate to Watsi</h4>
          Because we are committed to using 100% of your donation to fund medical treatments, we rely on donations from people like you to grow our impact. <a class="chapter__link" href="/about#donate#modal">Donate to Watsi's operational costs</a>.
          <br /><br />
          <h4 class="chapter__subheading">Be cool and spread the word</h4>
          Invite friends, family, and coworkers to <a class="chapter__link" href="/registration">join us</a> and <a class="chapter__link" href="/fund-treatments">fund treatments</a>.
        </p>
      </section>
    
      <section class="chapter">
        <h3 class="chapter__heading" id="teams">Team</h3>
        <p class="chapter__copy">
          <a class="chapter__link" href="http://watsi.tumblr.com/post/21043545556/" target="_blank">Chase Adam</a>, Vision, is full of optimistic passion. He spends his life looking toward the horizon.
          <br /><br />
          <a class="chapter__link" href="http://watsi.tumblr.com/post/21043338728/" target="_blank">Jesse Cooke</a>, Tech, develops software and is an avid contributor to the open source movement.
          <br /><br />
          <a class="chapter__link" href="http://watsi.tumblr.com/post/21043263585/" target="_blank">Grace Garey</a>, Marketing, is driven by hope and positivity. She's on a mission to connect people and create change.
        </p>
      </section>
      
      <section class="chapter chapter--advisors">
        <h3 class="chapter__heading" id="advisors">Advisors</h3>
        <p class="chapter__copy">
